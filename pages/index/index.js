...
Page({
  data: {
    items:[
      {
        name:'抖音',
        url:'../../images/logo-douyin.png',
      },
      {
        name:'快手',
        url:'../../images/logo-gitShow.png',
      },
      {
        name:'皮皮虾',
        url:'../../images/logo-ppx.png',
      },
      {
        name:'火山视频',
        url:'../../images/logo-volcano.png',
      },
      {
        name:'微视',
        url:'../../images/logo-microview.png',
      },
      {
        name:'美拍',
        url:'../../images/logo-meipai.png',
      },
      {
        name:'小咖秀',
        url:'../../images/logo-xiaokaxiu.png',
      },
      {
        name:'最右',
        url:'../../images/logo-zuiyou.png',
      }
    ],
    userInfo: {},
    videoUrl: '',
